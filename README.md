...
![Freighter](docs/screenshots/freighter-signing.png)
...
Please see [docs/architecture.md](docs/architecture.md) for detailed diagrams.
...
See [docs/mvp-scope.md](docs/mvp-scope.md) for detailed features and future milestones, including AMM integration and IPFS decentralized storage.
